<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Section.aspx.cs" Inherits="WebFormUI.Section" %>
            ...
            <div class="wrap-login100">
                <form class="login100-form validate-form" id="Form1" runat="server">
                    ...
                    <div class="wrap-form100">
                        ...
                        <span class="login100-form-title p-b-34 p-t-27">İşlem Türü
                        </span>
                        <div class="container-login100-form-btn">
                            <span class="login100-form-btn">
                                <asp:Button ID="btnCategories" Text="Gider Bilgisi" runat="server" CssClass="Btn-reset100" OnClick="btnCategories_Click" />
                            </span>
                        </div>
                    </div>
                </form>
