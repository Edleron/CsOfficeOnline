<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertExpences.aspx.cs" Inherits="WebFormUI.InsertExpences" %>
            ...
            <div class="wrap-login100">
                <form class="login100-form validate-form" id="Form1" runat="server">
                    ...
                    <div class="wrap-form100">
                        ...
                        <span class="login100-form-title p-b-34 p-t-27">Gider Ekle
                        </span>
                        <div class="wrap-input100 validate-input" data-validate="Enter username">
                            <input class="input100" type="text" name="txtExpenselName" placeholder="Gider İsmi">
                            <span class="focus-input100" data-placeholder="&#xf207;"></span>
                        </div>
                        <div class="wrap-input100 validate-input" data-validate="Enter username">
                            <input class="input100" type="number" name="txtUnitPrice" placeholder="Fiyatı">
                            <span class="focus-input100" data-placeholder="&#xf129;"></span>
                        </div>
                        <div class="wrap-input100 validate-input" data-validate="Enter username">
                            <input class="input100" type="text" name="txtExplanation" placeholder="Açıklama">
                            <span class="focus-input100" data-placeholder="&#xf25b;"></span>
                        </div>
                        <div class="wrap-input100 validate-input" data-validate="Enter username">
                            <input class="input100" type="date" name="txtDateTime">
                            <span class="focus-input100" data-placeholder="&#xf337;"></span>
                        </div>
                        <div class="container-login100-form-btn p-b-34 p-t-27">
                            <span class="login100-form-btn">
                                <asp:FileUpload ID="fileUploadImage" runat="server" BorderStyle="Solid" BackColor="#33cccc" CssClass="Btn-reset100" />
                            </span>
                        </div>
                        <div class="container-login100-form-btn">
                            <span class="login100-form-btn">
                                <asp:Button ID="btnInsertCategory" Text="Ekle" runat="server" CssClass="Btn-reset100" OnClick="btnInsertCategory_Click" />
                            </span>
                        </div>
