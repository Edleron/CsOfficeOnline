<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertCategories.aspx.cs" Inherits="WebFormUI.InsertCategories" %>
            ...
            <div class="wrap-login100">
                <form class="login100-form validate-form" id="Form1" runat="server">
                    ...
                    <div class="wrap-form100">
                        ...
                        <span class="login100-form-title p-b-34 p-t-27">Kategori Ekleme
                        </span>
                        <div class="wrap-input100 validate-input" data-validate="Enter username">
                            <input class="input100" type="text" name="txtCategoryName" placeholder="Kategori İsmi">
