<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExpencesAccess.aspx.cs" Inherits="WebFormUI.ExpencesAccess" %>
            ...
            <div class="wrap-login100">
                <form class="login100-form validate-form" id="Form1" runat="server">
                    ...
                    <div class="wrap-form100">
                        ...
                        <span class="login100-form-title p-b-34 p-t-27">Project
                        </span>
                        <div class="container-login100-form-btn p-b-34 p-t-27">
                            <span class="login100-form-btn">
                                <asp:DropDownList ID="cbxCategory" runat="server" CssClass="Btn-reset100" OnSelectedIndexChanged="cbxCategory_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                            </span>
                        </div>
                        <div class="container-login100-form-btn">
                            <span class="login100-form-btn">
                                <asp:Button ID="btnNewInsertCategory" Text="Yeni Kategori Ekle" runat="server" CssClass="Btn-reset100" OnClick="btnNewInsertCategory_Click" />
                            </span>
                        </div>
                    </div>
                </form>
